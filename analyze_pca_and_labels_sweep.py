...
def main():
    ...
    ap.add_argument("--pca_glob", default="results/pca/*.pt")
    ap.add_argument("--labels_glob", default="results/labels/*.jsonl")
    ap.add_argument("--outdir", default="results/analysis_pca")
