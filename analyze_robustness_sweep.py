...
def main():
    ...
    ap.add_argument("--in_glob", default="results/directions/direction_records_seed*_layer*_eps*_*_n*.pt")
    ap.add_argument("--outdir", default="results/analysis_robustness")
