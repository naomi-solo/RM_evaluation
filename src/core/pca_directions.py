...
def main():
    ...
    in_path = f"results/outputs/directions/direction_records_seed{seed_default}_layer{layer_default}_eps{eps_default}_{cc}_{tag}_n{n_default}.pt"
    ...
    out_path = f"results/outputs/pca/pca_seed{seed_default}_layer{layer}_eps{eps}_k{k_eff}_{cc}_{tag}_{mode}_n{X.shape[0]}.pt"
    torch.save(
        {
