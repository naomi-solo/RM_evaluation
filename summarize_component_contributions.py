...
def main():
    # ---- Inputs ----
    pca_path = os.getenv("PCA_PATH", "results/pca_layer14_eps8.0_k10_ambig_flip_chosen_n200.pt")
    labels_path = os.getenv("LABELS_PATH", "results/component_labels_layer14_eps8.0_K10_ambig_flip_chosen.jsonl")
