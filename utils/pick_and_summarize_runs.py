...
def main():
    ...
    ap.add_argument("--pca_glob", default=os.getenv("PCA_GLOB", "results/outputs/pca/*.pt"))
    ap.add_argument("--label_glob", default=os.getenv("LABEL_GLOB", "results/outputs/labels/*.jsonl"))
